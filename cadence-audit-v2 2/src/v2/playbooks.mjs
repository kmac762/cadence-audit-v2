...
export const PLAYBOOKS={
  "headings": {
    ...
    "talk": "We would check whether these pages clearly name the services or topics you want them found for, then correct the wording or template where needed. The aim is a clear main topic and useful search-result title source, not adding a tag just to pass an audit.",
