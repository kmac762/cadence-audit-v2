  ...
  "recommendations": [
    {
      "id": "sample:h1",
      "playbook": "headings",
      "title": "Strengthen each page's main search topic",
      "theme": "On-page",
      "observation": "The main heading element (H1) was not detected in the inspected HTML for 14 of 14 example pages.",
      "why": "Search connection: topic clarity and the title displayed in search results. Google uses the main visual title and heading elements, including H1s, among its title-link sources. A descriptive heading reinforces the service or topic the page should be found for; the tag alone is not the objective.",
      "searchEffect": "Supported: a clearer source for Google's title link and page-topic interpretation. Not established: lost rankings or AI citations from a missing H1 alone. Other prominent text may already communicate the topic.",
      "solution": [
        "Confirm what each affected page should be found for. Compare its visible title, title tag and main heading in the initial and rendered HTML; confirm that the missing-H1 observation is real.",
        "Check whether the affected pages share a CMS template. Where needed, use a descriptive, search-relevant main title as the H1 and align the supporting copy with that topic. Avoid keyword stuffing and unnecessary visual redesign.",
        "Recheck heading output on the affected pages. With client access, use URL Inspection and monitor page/query impressions, displayed titles and clicks after recrawling; separate the implementation fix from any measured search outcome."
      ],
      "success": "The page clearly names its intended search topic and exposes the appropriate main heading. A follow-up scan verifies the output; Search Console and search-result review are used to assess visibility rather than promise a ranking gain.",
      "verify": "Confirm what each affected page should be found for. Compare its visible title, title tag and main heading in the initial and rendered HTML; confirm that the missing-H1 observation is real.",
      "caveat": "A missing H1 does not establish a ranking penalty. Heading order and tag counts alone do not establish search harm. A shared template is a hypothesis until checked.",
      ...
      "talk": "The main heading element (H1) was not detected in the inspected HTML for 14 of 14 example pages. We would check whether these pages clearly name the services or topics you want them found for, then correct the wording or template where needed. The aim is a clear main topic and useful search-result title source, not adding a tag just to pass an audit.",
